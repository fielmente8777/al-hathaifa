...
const Service = () => {
    ...
    const data = [
        ...
        },
        {
            ...
            "description": "Al HATHAIFA is dedicated to offering businesses advanced Field Force Management solutions that revolutionize their field operations and drive productivity to new heights. Our extensive range of services covers all aspects of field management, including workforce scheduling, route optimization, task assignment, performance tracking, and beyond.",
