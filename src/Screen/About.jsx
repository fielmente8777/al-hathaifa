...
import img4 from "../assets/BannerImage/6c8a14ff5c_11zon.jpeg"
...
const About = () => {
    ...
    return (
        <div>
            ...
            <Helmet>
                <title>About Al-Hathaifa - Leading Manpower and Sales Force Solutions in Muscat, Oman</title>
                <meta name="description" content="Learn about Al-Hathaifa, the premier provider of manpower and sales force solutions in Muscat, Oman. Discover our mission, values, and commitment to excellence in delivering expert services to elevate your business success." />
            </Helmet>
