            ...
            <div className="relative mt-2.5 w-full max-w-[1224px] max-md:max-w-full">
                <div className="flex gap-5 max-md:flex-col max-md:gap-0 max-md:">
                    ...
                    <div className="flex flex-col ml-5 w-[39%] max-md:ml-0 max-md:w-full">
                        ...
                        <iframe className="mt-20 w-full aspect-[2.7] hidden max-md:block max-md:mt-10 max-md:max-w-full" src="https://www.google.com/maps/embed?pb=!1m10!1m8!1m3!1d7312.364105690263!2d58.446202!3d23.597803!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sin!4v1707988951047!5m2!1sen!2sin" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
