...
const Bussiness = () => {
    return (
        <div className='px-24 flex justify-center py-10'>
            <div className="flex flex-col max-w-[1224px]">
                <div className="flex justify-between text-4xl text-red-800 uppercase leading-[60px] max-md:flex-wrap max-md:max-w-full">

                    <div className='p-2' style={{ borderLeft: "6px solid #A52323" }}>
                        <h1 className="text-5xl font-bold uppercase text-[#363636] font-normal" >
                ...
                <div className="mt-12 w-full text-base font-medium leading-6 text-justify text-neutral-400 max-md:mt-10 max-md:max-w-full">
                    Al HATHAIFA is a trusted brand in Oman with a decade-plus of competitive
