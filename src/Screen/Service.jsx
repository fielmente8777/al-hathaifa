...
import Sales from "../assets/client-img/sales.jpg";
import Operation from "../assets/client-img/mangement.jpg";
import recruit from "../assets/client-img/recruitment.jpg";
import support from "../assets/client-img/logistic.jpg";
import indus from "../assets/client-img/delivery.jpeg";
import facility from "../assets/client-img/facilitymanagement.jpg";
import filed from "../assets/client-img/forcemangement.jpg";
import corpo from "../assets/client-img/coporate.jpg";
const Service = () => {
  useEffect(() => {
