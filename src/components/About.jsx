                ...
                <div className=" flex flex-col justify-start ">
                    <div className='' style={{ borderLeft: "6px solid #A52323" }}>
                        <div className="pl-2 grow ">
                            <h1 className="text-5xl max-md:text-4xl uppercase font-bold text-[#363636]">Where vision meets reality, we are at your service!<span style={{ color: "#A52323" }}></span></h1>
                    ...
                    <Link to="/about" className="mt-3">
                        <button className="flex items-center px-8 py-4 bg-[#a52323] hover:bg-red-700 transition-colors">
                            <div className="text-white text-base font-bold uppercase tracking-[0.16] leading-[24px]">
                                About Us
                            </div>
                        </button>
                    </Link>
