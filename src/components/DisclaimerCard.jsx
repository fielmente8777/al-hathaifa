        ...
        <div className="flex flex-col text-left items-start max-w-[1224px]">
          <div className="" style={{ borderLeft: "6px solid #A52323" }}>
            <div className="pl-2 grow ">
              <h1>
                {" "}
                <span className="text-[40px] font-medium   leading-8 max-md:leading-0 max-md:text-4xl capitalize text-[#363636]">
                  {pageData.heading}
                </span>
              </h1>
            </div>
          ...
          <div className="max-md:mt-0 grow text-base font-medium leading-6 text-justify w-[1224px] max-md:w-full  text-black">
            ...
            <p className="my-6">{pageData.description4}</p>
            <p className="my-6">{pageData.description5}</p>
          </div>
        </div>
      </div>
    </div>
