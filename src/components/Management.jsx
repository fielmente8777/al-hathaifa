        ...
        <div className="management">
            <div className=" flex flex-col justify-center border-3 w-full max-w-[1224px] py-14 max-md:px-5 max-md:py-8">
                <div className='' style={{ borderLeft: "6px solid #A52323" }}>
                    <div className="pl-2 grow text-[#363636]  ">
                        <h1 className="text-5xl text-white uppercase font-bold max-md:text-4xl">Message from  <span style={{ color: "#A52323" }}>management</span></h1>
