...
const BannerCard = () => {
    return (
        <div className="flex overflow-hidden w-full relative flex-col justify-center text-lg font-semibold leading-7 text-white min-h-[712px]">
=======
...
<<<<<<< HEAD
            <div className="flex relative flex-col items-center px-20 py-12 w-full bg-black bg-opacity-40 max-md:px-5 max-md:max-w-full">
                ...
                <div className="mt-3 text-center leading-[167%] max-md:max-w-full">
...
=======
            <div className="flex relative flex-col items-center px-20 py-24 w-full bg-black bg-opacity-40 max-md:px-5 max-md:max-w-full">
                <div className="mt-40 uppercase whitespace-nowrap tracking-[4px] max-md:mt-10">
                    <p>Welcome to al HATHAIFA</p>
                </div>
                <div className="mt-3 text-6xl text-center uppercase leading-[60px]  max-md:max-w-full max-md:text-4xl max-md:leading-10">
                    <h1>Where expertise meets opportunity</h1>
                </div>
