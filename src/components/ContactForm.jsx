...
const ContactForm = () => {
    return (
        <div className='flex flex-col justify-center items-center'>
            <div className="flex gap-5 py-20 max-w-[1224px] max-md:flex-col max-md:gap-0 max-md:">
                <div className="flex flex-col w-[61%]  max-md:ml-0 max-md:w-full">
                    <div className="flex flex-col items-start text-base font-medium leading-[60px] text-neutral-400 max-md:mt-10 max-md:max-w-full">
                        <div className='p-2' style={{ borderLeft: "6px solid #A52323" }}>
                            <h1 className="text-5xl font-bold uppercase text-[#363636] font-normal">Where to Find <stronge style={{ color: "#A52323" }}>US </stronge></h1>
                        ...
                        <div className="mt-12 text-4xl text-justify text-red-800 uppercase max-md:mt-10">
            ...
            <iframe className=" w-full max-w-[1224px] h-[458px] aspect-[2.7] max-md:mt-10 max-md:max-w-full" src="https://www.google.com/maps/embed?pb=!1m10!1m8!1m3!1d7312.364105690263!2d58.446202!3d23.597803!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sin!4v1707988951047!5m2!1sen!2sin" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
