    ...
    return (
        ...
        <div className="mission chooseService py-12  gap-4 max-md:px-5 max-md:py-5">
            <div className='max-w-[1224px] grid grid-cols-2 max-md:grid-cols-1'>
                ...
                <div className='max-md:order-2 max-md:mt-24'>
                    <div className=" flex flex-col justify-center border-3 ">
                        <div className='border-[#A52323] max-md:border-l-[6px] lg:border-r-[6px]'>
                            <h1 className=" max-md:pl-2 text-5xl max-md:text-4xl text-white uppercase font-bold">why you should choose our  <span style={{ color: "#A52323" }}> services? </span></h1>
                        </div>
                        ...
                        <div className="flex gap-5 justify-between pr-20 mt-4 w-full font-semibold text-justify whitespace-nowrap leading-[150%] max-md:flex-wrap max-md:pr-5 max-md:max-w-full">
                            <div className="flex gap-3 justify-between">
                                <img alt="ISO"
                                    ...
                                    className="w-6 aspect-square fill-red-800"
                                />
                                <div className=" grow text-white text-md">ISO Certified</div>
                            </div>
                            <div className="flex gap-3 justify-between">
                                <img alt="Diversity"
                                    loading="lazy"
                ...
                <div className=''>
                    <div className=" experiencecard flex z-10 flex-col left-[52%] max-md:left-[29%] self-stretch px-7 py-9 my-auto uppercase bg-white rounded-3xl h-[187px] max-md:px-5">
                        <div className="text-6xl text-red-800 font-bold leading-[59.92px] max-md:text-4xl">
                            8+
                        </div>
                        <div className="mt-2 text-2xl font-bold leading-7 text-black">
                            Years of  <br /> experience
                        </div>
                    </div>
                    <div className=" flex justify-end max-md:mb-5">
                        <img className=" object-cover overflow-hidden	w-[460px] h-[460px] " src={ChooseServiceImage} alt="About" />
                    </div>
                </div>
